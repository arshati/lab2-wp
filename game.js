...
class Bee {
    constructor(beeNumber) {
        ...
        this.display = function() {
            ...
            this.firBounds(); //add this to adjust to bounds
            this.htmlElement.style.left = this.x + "px";
            this.htmlElement.style.top = this.y + "px";
            this.htmlElement.styl.display = "block";
...
function moveBees() {
    ...
    let speed = document.getElementById("speedBees").ariaValueMax;
...
function updateBees() { //update loop for game
    ...
    let period = document.getElementById("timer"); //modify this to control
...
function overlap(element1,element2) {
    ...
    left1 = element1.htmlElemenet.offsetLeft;
